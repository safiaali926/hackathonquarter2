...
export default function Mirrorshop() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const query = `
          *[_type == "product" && "Mirror" in categories] | order(_createdAt desc) {
            _id,
            title,
            description,
            price,
    ...
    <div className="min-h-screen py-10 px-6">
      ...
      <div className="max-w-7xl mx-auto bg-white p-4 rounded-lg mb-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-pink-500">Explore Our Collection of Fancy Wall Mirrors!</h1>
